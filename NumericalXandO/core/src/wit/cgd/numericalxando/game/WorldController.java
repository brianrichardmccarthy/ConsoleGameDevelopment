...
public class WorldController extends InputAdapter {
    ...
    private void init() {
        ...
        else if (GamePreferences.instance.firstPlayerSkill <= 3.0f) board.firstPlayer = new RandomImpactSpacePlayer(
            board, board.X);
        else if (GamePreferences.instance.firstPlayerSkill <= 6.0f) board.firstPlayer = new CheckAndImpactPlayer(board,
            board.X);
        ...
        else if (GamePreferences.instance.secondPlayerSkill <= 3.0f) board.secondPlayer = new RandomImpactSpacePlayer(
            board, board.O);
        else if (GamePreferences.instance.secondPlayerSkill <= 6.0f) board.secondPlayer = new CheckAndImpactPlayer(
            board, board.O);
